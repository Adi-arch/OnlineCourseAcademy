...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/js/bootstrap.bundle.min.js" integrity="sha384-gtEjrD/SeCtmISkJkNUaaKMoLD0//ElJ19smozuHV6z3Iehds+3Ulb9Bn9Plx0x4" crossorigin="anonymous"></script>
    ...
    <body id="page-top">
            ...
            <div class="container-fluid p-0">
                <div class="row no-gutters">
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="{{ url('/images/portfolio/fullsize/1.jpg')}}">
                            <img class="img-fluid" src="{{ url('/images/portfolio/thumbnails/1.jpg')}}" alt="" />
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="{{ url('/images/portfolio/fullsize/2.jpg')}}">
                            <img class="img-fluid" src="{{ url('/images/portfolio/thumbnails/2.jpg')}}" alt="" />
                            <div class="portfolio-box-caption">
                                <div class="project-category text-white-50">Category</div>
                                <div class="project-name">Project Name</div>
                            </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="{{ url('/images/portfolio/fullsize/3.jpg')}}">
                            <img class="img-fluid" src="{{ url('/images/portfolio/thumbnails/3.jpg')}}" alt="" />
                            <div class="portfolio-box-caption">
                                <div class="project-category text-white-50">Category</div>
                                <div class="project-name">Project Name</div>
                            </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="{{ url('/images/portfolio/fullsize/4.jpg')}}">
                            <img class="img-fluid" src="{{ url('/images/portfolio/thumbnails/4.jpg')}}" alt="" />
                            <div class="portfolio-box-caption">
                                <div class="project-category text-white-50">Category</div>
                                <div class="project-name">Project Name</div>
                            </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="{{ url('/images/portfolio/fullsize/5.jpg')}}">
                            <img class="img-fluid" src="{{ url('/images/portfolio/thumbnails/5.jpg')}}" alt="" />
                            <div class="portfolio-box-caption">
                                <div class="project-category text-white-50">Category</div>
                                <div class="project-name">Project Name</div>
                            </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="{{ url('/images/portfolio/fullsize/6.jpg')}}">
                            <img class="img-fluid" src="{{ url('/images/portfolio/thumbnails/6.jpg')}}" alt="" />
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        ...
                        <hr class="divider my-4" />
                        <p class="text-muted mb-5">Ready to start learning with us? Give us a call or send us an email and we will get back to you as soon as possible!</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
                        <i class="fas fa-phone fa-3x mb-3 text-muted"></i>
                        <div>+91 8375308213</div>
                    </div>
                    <div class="col-lg-4 mr-auto text-center">
                        <i class="fas fa-envelope fa-3x mb-3 text-muted"></i>
                        <!-- Make sure to change the email address in BOTH the anchor text and the link target below!-->
                        <a class="d-block" href="mailto:skillsuniversity@reddifmail.com">skillsuniversity@reddifmail.com</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Copyright © 2021 - Skills University</div></div>
        </footer>
        <!-- Bootstrap core JS-->
