                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="#">
                                <svg class="svg-icon" viewBox="0 0 20 20" width="30" height="30">
                                    <path
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('instructor.studentsEnrolled')}}">
                                <svg class="svg-icon" viewBox="0 0 20 20" width="30" height="30">
                                    <path
                    ...
                    <table class="table table-striped table-sm border">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <form action="{{route('instructor.courseDelete',$course->id)}}" method="post">
                                        @csrf
                                        <button class="btn btn-primary" type="submit"
                                            value="{{$course->id}}">Delete</button>
                                    </form>
                                </td>
                            </tr>
                        </tbody>
