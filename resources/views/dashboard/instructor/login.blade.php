            ...
            <div class="row d-flex">
                ...
                <div class="col-lg-6">
                    <div class="card1 pb-5 ">
                        ...
                        <div class="row px-3 justify-content-center mt-4 mb-5 border-line"> <img src= "/images/instructorb.jpg" class="image" style=" margin-left:100px; width: 700px;
        height: 450px"> 
                        </div>
                    </div>
                </div>  
        ...
        height: 450px;">
                    <div class="row mb-4 px-3">
                        ...
                        <form action="{{route('instructor.check')}}" method="post" autocomplete="off">
                            ...
                            <br>
                            <a href="{{ route('instructor.register') }}" style="padding-left:50px;">Create new Account</a>
                        </form>
                    </div>
                </div>
        </div>
